...
จะมีตัวแปร 1 ตัวคอยรับค่าที่ส่งมาจาก Main ซึ่งตัวแปรของแต่ละฟังก์ชั่นจะกำหนดชนิดตัวแปรไว้ int double string ตามลำดับ ก็คือถ้าค่าที่รับมาจากฟังก์ชั่น Main เป็นชนิด int ฟังก์ชั่น print ที่มีชนิดตัวแปรเป็น int จะรับค่ามาแสดงผล 

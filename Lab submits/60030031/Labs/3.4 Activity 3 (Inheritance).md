...
อธิบายการทำงาน ตามที่เข้าใจ
    เมื่อรันขึ้นมาขึ้นว่า Teacher charge = 7000
    เนื่องจากค่า techer.TypeName() ได้ส่งค่า Teacher และ CalculateCharge จะรีเทิร์นค่า hours * billingRate ซึ่งจะได้เท่ากับ 20*350
...
รันและสังเกตผลการทำงานของโปรแกรม มีสิ่งใดผิดปกติหรือไม่ อย่างไร
อธิบายการทำงาน ตามที่เข้าใจ
    เมื่อกดรันสิ่งที่เพิ่มขึ้นมาคือ Professor charge = 11000 
    เนื่องจาก prof.TypeName() ได้รีเทิร์นค่า Professor มา
    prof.CalculateCharge ได้รีเทิร์นค่าเป็น (hours * billingRate) + emolument โดย emolument เมื่อมากกว่า 1 ชม.ให้กำหนดเป็น 1 ชม. ทำให้ได้เท่ากับ (12*600) + 5000

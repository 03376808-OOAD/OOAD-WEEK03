...
อธิบายการทำงาน ตามที่เข้าใจ
    รันได้ปกติ ผลลัพธ์ที่ออกมาจะออกมาตาม type ของตัวแปร โดย class จะหาให้ตรงกับ field เช่น 5 เป็น int จะขึ้นเป็น int 5.26 ได้มีการ converse ให้เป็น string จึงขึ้นใน string 
...
รันและสังเกตผลการทำงานของโปรแกรม มีสิ่งใดผิดปกติหรือไม่ อย่างไร
อธิบายการทำงาน ตามที่เข้าใจ
    การงานได้ปกติ โดยที่ v1 และ v2 เป็นการรีเทิร์นค่าปกติ v3 เป็นการเรียกใช้ operator +(Vector v1, Vector v2) และ -v3 เป็นการเรียกใช้ operator -(Vector v1)
...
คลาสแม่มีการประกาศ base class เป็น virtual เมื่อคลาสลูกใช้ override method จะสามารถใช้คุณสมบัตืที่ต้องการ

การประกาศที่ทำให้เกิด method overriding
...
การประกาศที่ทำให้เกิด method hiding.

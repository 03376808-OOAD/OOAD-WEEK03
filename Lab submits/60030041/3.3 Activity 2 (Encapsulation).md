...
Student GPA จาก 3.5 เปลี่ยนเป็น 7.5
...
รันและสังเกตผลการทำงานของโปรแกรม มีสิ่งใดผิดปกติหรือไม่ อย่างไร
ไม่สามารถรันโปรแกรม เพราะไม่สามารถกำหนดค่าให้กับ fieldsได้ access modifierเป็น private
...
```
รันและสังเกตผลการทำงานของโปรแกรม มีสิ่งใดผิดปกติหรือไม่ อย่างไร
สามารถรันโปรแกรมได้เพราะเข้าถึงfields ผ่าน propertiesที่เป็น public
...
## สรุปผลการทดลอง
ไม่สามารถรันโปรแกรมได้เพราะ u.Name = "My name";  ไม่มีกำกำหนดเมธอด setter ไว้ 
เปลี่ยนค่ามากกว่า 4.0 มีข้อความ Error!!!! invalid GPA

...
ผลลัพธ์ แสดง  Teacher และ charge = 7000
 class Teacher มี field Teacher รับค่า name และ billingRate 
 และ field CalculateCharge จะรับค่า hours และมาคำนวน แล้วส่งค่ากลับ 
 และ field TypeName มีการส่งค่ากลับเป็น "Teacher" 
 สรุปว่า มีการสร้างวัตถุ teacher มีการเข้าถึง field Teacher และ billingRate
 และมีการคำนวนรายได้ field CalculateCharge มีการส่งค่า 20 คือ 20 hr/month
 และผลการคำนสวน = 7000
...
รันและสังเกตผลการทำงานของโปรแกรม มีสิ่งใดผิดปกติหรือไม่ อย่างไร
อธิบายการทำงาน ตามที่เข้าใจ
มีการสร้างวัตถุขึ้นมา จาก class Professor ซึ่งสืบทอดมาจาก Teacher ซึ่ง class Professor
จะมีทุกอย่างเหมือน class Teacher แต่จะมีความสามารถมากกว่า คือ จะมี เงินประจำตำแหน่งเพิ่มมา

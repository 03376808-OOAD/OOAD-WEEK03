...
ตอบ GPAหน้าแสดงผล เปลี่ยนจาก3.5 เป็น7.5
...
ตอบ ไม่มีการเปลี่ยนแปลงของผลที่แสดง
...
ตอบ ใส่ค่าที่ถูกต้อง https://github.com/03376808-OOAD-2562/OOAD-WEEK03/blob/master/imgs/P1.PNG

   ใส่ค่าผิด https://github.com/03376808-OOAD-2562/OOAD-WEEK03/blob/master/imgs/P2.PNG
...
ตอบ เรากำหนดค่า name และ id ในobjectแล้ว เมื่อลบ // ด้านหน้า su.Name = "My name"; ออก ไมาสามารถแสดงผลได้ เพราะเกิด error 

เมื่อเปลี่ยนเกรดให้มากกว่า4.0 จะแสดง Error!!!! invalid GPA
 
## สรุปผลการทดลอง

ตอบ จากการทดลองทำให้ทราบถึงวิธีการเข้าถึงข้อมูลระหว่าง class ได้ง่าย และเขียน code น้อยลง

...
```
สร้างตัวแปรชื่อ myPoint โดยมี Ref. Type คือ Class ที่ชื่อ Point แล้วทำการเชื่อมตัวแปรดังกล่าวเข้ากับ Class ตัวใช้คีย์เวิร์ด new ตามด้วยชื่อ Class ร่วมกับตัวดำเนินการ =
```
...
```
เป็นการเรียกใช้ Property X และ Property Y ในการกำหนดค่าให้ field x มีค่าเท่ากับ 10 และ field y มีค่าเท่ากับ 10
```
...
โปรแกรมสามารถทำงานได้ปกติ จากการรันของโปรแกรมโปรแกรมจะมีการเรียกใช้คลาส Teacher และ field อีก 3 field เพื่อทำการคำนวนเงินเดือนให้กับครู
...
โปรแกรมสามารถทำงานได้ปกติ จากการเพิ่มโค๊ดเข้าไปมีการสร้าง class ที่สืบทอดมาจาก class Teacher ที่ชื่อ class Professor ซึ่งจะแตกต่างตรงที่มีเงินประจำตำแหน่งเพิ่มขึ้นมาและบวกเงินประจำตำแหน่งในการคำนวนเงินเดือนด้วย

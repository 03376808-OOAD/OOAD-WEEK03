...
```
ในคลาส Teacher มี constructor name,billingRate สำหรับส่งค่ากลับออกไปแสดงผล ภายในคลาส Teacher ยังมีฟังก์ชั่น
CalculateCharge,TypeName ที่จะส่งค่ากลับเมื่อมีการเรียกใช้ฟังก์ชั่น 
ในฟังก์ชั่น Main มีการกำหนดค่าเอาไว้สำหรับการคำนวนเมื่อเรียกใช้ฟังก์ชั่นก็จะใช้ค่าที่กำหนดส่งไปคำนวนในฟังก์ชั่น
```
...
รันและสังเกตผลการทำงานของโปรแกรม มีสิ่งใดผิดปกติหรือไม่ อย่างไร
```
โปรแกรมรันได้ปกติ ตอนแรกหน้าจอโปรแกรมแสดงข้อความ Teacher charge 7000 เมื่อ
Enter จะมีข้อความแสดงอีกบรรทัดว่า Professor charge 11000
```
อธิบายการทำงาน ตามที่เข้าใจ
```
เพิ่ม class Professor สืบทอดคุณสมบัติมากจากคลาส Teacher มี constructor 2 ตัว ตัวแรกช่วยในการเก็บค่าตัวแปรที่เป็น private และ protected ลงใน fileds ส่วนอีกตัว เพิ่มตัวแปร emolument และในฟังก์ชั่น CalculateCharge,TypeName เมื่อถูกเรียกใช้งานจะส่งค่ากลับไป
ในฟังก์ชั่น Main มีการกำหนดค่าเอาไว้สำหรับการคำนวนเมื่อเรียกใช้ฟังก์ชั่นก็จะใช้ค่าที่กำหนดส่งไปคำนวนในฟังก์ชั่น
```

# 2. การทดลองเรื่องการปกปิดข้อมูลหรือการห่อหุ้ม (Encapsulation)
## 2.1 การเข้าถึง fields แบบ public
...
## 2.2 การเข้าถึง fields ผ่านทาง properties
...
## 2.3 การตรวจสอบความถูกต้องของข้อมูลโดย properties
...
## 2.4 การกำหนดวิธีการเข้าถึงข้อมูลภายในคลาส
